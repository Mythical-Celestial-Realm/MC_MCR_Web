...
<head>
    ...
    <style>
        .logo { text-decoration: none; margin: 32px; font-size: 1.5rem; color: #000;}
        .markdown-body { max-width: 900px; margin: 40px auto; background: #fff; padding: 32px; border-radius: 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05); }
        .edit-form textarea { width: 100%; height: 400px; font-size: 1rem; font-family: 'Consolas', 'monospace'; margin-bottom: 16px; }
        .edit-form button { padding: 8px 24px; font-size: 1rem; }
    </style>
